...
class PageFactory(private val mContext: Context,
    ...
    private val batteryView: ProgressBar? = null
    ...
    init {
        ...
        mTitlePaint.color = ContextCompat.getColor(ReaderApplication.readerApplication, R.color
                .chapter_title_day)
    ...
    fun onDraw(canvas: Canvas) {
        ...
        if (mLines!!.size > 0) {
            ...
            // 绘制标题
            canvas.drawText(chaptersList[currentChapter - 1].title, marginWidth.toFloat(), y.toFloat(),
                    mTitlePaint)
    ...
    fun convertBetteryBitmap() {
        //        batteryView = (ProgressBar) LayoutInflater.from(mContext).inflate(R.layout
        //                .layout_battery_progress, null);
        ...
        //        batteryView.measure(View.MeasureSpec.makeMeasureSpec(ScreenUtils.dpToPxInt(26), View
        //                        .MeasureSpec.EXACTLY),
        //                View.MeasureSpec.makeMeasureSpec(ScreenUtils.dpToPxInt(14), View.MeasureSpec
        //                        .EXACTLY));
